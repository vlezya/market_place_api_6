...
class Api::V1::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should show orders' do
    get api_v1_orders_url(@order), headers: { Authorization: JsonWebToken.encode(
  ...
  test 'should show order' do
    get api_v1_orders_url(@order), headers: {
      Authorization: JsonWebToken.encode(user_id: @order.user_id) }, as: :json
  ...
  test 'should create order with two products' do
    assert_difference('Order.count', 1) do
      ...
      params: @order_params, headers: { Authorization: JsonWebToken.encode(user_id:
